...
//var 	emailtosend = email;
	...
	var remoteHost = "8082"
	var link = "http://localhost:8082/email/verify?mail=" + email_id;
	console.log(link);
...
var sql = "INSERT INTO types(type_name,type_description)VALUES ('" + type_name + "','" + type_description + "')";
con.query(sql, function (err, result) {
	if (err) throw err;
	dbFunc.connectionRelease;
...
logger.fatal("DataBase ERR:",err)
console.log(result,"inserted.......")
res.send({Message:"A verification link is sent to your email.Please check your email",
الرسالة: "تم إرسال رابط التحقق إلى بريدك الإلكتروني. يرجى التحقق من بريدك الإلكتروني"
})
